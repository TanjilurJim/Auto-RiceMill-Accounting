...
import loginImg from '@/../../public/assets/undraw_my-app_15n4.svg';
                        ...
                        <form className="flex flex-col gap-6" onSubmit={submit}>
                            <div className="grid gap-6">
                                <div className="grid gap-2">
                                    ...
                                    <Input id="name" type="text" required autoFocus tabIndex={1} autoComplete="name" value={data.name}
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input id="email" type="email" required tabIndex={2} autoComplete="email" value={data.email} onChange={(e)=>
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input id="password" type="password" required tabIndex={3} autoComplete="new-password" value={data.password}
