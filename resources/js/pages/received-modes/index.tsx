...
export default function Index({ receivedModes }: { receivedModes: PaginatedReceivedModes }) {
              ...
              {modes.length > 0 ? (
                modes.map((mode) => (
                  <tr key={mode.id} className="hover:bg-gray-50">
                    <td className="border px-3 py-2 text-center">{mode.id}</td>
