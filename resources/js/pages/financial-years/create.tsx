...
export default function Create() {
    ...
    return (
        <AppLayout>
            <Head title={t('fyCreatePageTitle')} />
            <div className="bg-background h-full w-screen p-4 md:p-12 lg:w-full">
                <div className="bg-background h-full rounded-lg">
                    <PageHeader title={t('fyAddYearTitle')} addLinkHref="/financial-years" addLinkText={t('fyBackButton')} />
                    ...
                    <form onSubmit={handleSubmit} className="bg-background space-y-6 rounded-lg border p-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder={t('fyTitlePlaceholder')}
                            />
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            {/* Start Date */}
                            <div>
                                <InputCalendar label={t('fyStartDateLabel')} value={data.start_date} onChange={(val) => setData('start_date', val)} />
                                {errors.start_date && <p className="mt-1 text-sm text-red-600">{errors.start_date}</p>}
                            </div>

                            {/* End Date */}
                            <div>
                                <InputCalendar label={t('fyEndDateLabel')} value={data.end_date} onChange={(val) => setData('end_date', val)} />
                        ...
                        <div className="flex items-center gap-2">
                            <CheckBox
                                ...
                                label={t('fyMarkAsClosedLabel')}
                            />
                        </div>

                        <ActionFooter
                            processing={processing}
                            submitText={processing ? t('fySavingText') : t('fySaveButton')}
