...
export default function CreateRole({ modules }: Props) {
    ...
    return (
        <AppLayout>
            ...
            <PageHeader title="Create New Role" description="Define permissions and access levels" addLinkHref="/roles" addLinkText="Back to Roles" />
            ...
            <form onSubmit={submit} className="rounded-xl border border-gray-100 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
                {/* Role Name */}
                <div className="mb-8">
                        ...
                        {filteredModules.length > 0 ? (
                            filteredModules.map((module) => (
                                <div key={module.name} className="overflow-hidden rounded-lg border">
                                    <button
                                        type="button"
                                        className="flex w-full items-center justify-between bg-gray-50 p-4 hover:bg-gray-100 dark:bg-neutral-800 dark:hover:bg-neutral-700"
                                    ...
                                    >
                                        ...
                                        <svg
                                            className={`h-5 w-5 transition-transform ${expandedModules[module.name] ? 'rotate-180' : ''}`}
                                            fill="none"
                                            viewBox="0 0 24 24"
                                            stroke="currentColor"
                                        >
